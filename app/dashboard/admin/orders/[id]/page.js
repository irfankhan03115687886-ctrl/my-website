...
export default async function DashboardOrderDetailPage({ params }) {
  ...
  if (!order) {
    return (
      <div>
        <Link href="/dashboard/admin/orders" className="inline-flex items-center gap-1.5 font-mono text-xs uppercase tracking-[0.12em] text-cream/60 hover:text-cream">
